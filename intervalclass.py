"""
``interval`` --- Interval arithmetic and Newton's method
------------------------------------

This module provides the interval class for interval arithmetic and Newton's method.
"""
...
class interval(tuple):
    """A interval on the extended real set.
    ...
    def newton(self, f, p, maxiter=10000, tracer_cb=None):
        ...
        For example, the following solves x**3 == x in [-10, 10]:
